...
lidar_197_t, lidar_197_d = read_lidar_data('processed_data_286.json')
lidar_201_t, lidar_201_d = read_lidar_data('processed_data_290.json')
...
labels = ['Vehicle 286 LiDAR', 'Vehicle 290 LiDAR', 'Improved RSSI']
