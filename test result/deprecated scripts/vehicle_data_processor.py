...
def process_data(id, input_dir, output_dir):
    ...
    with open(lidar_file, 'r') as f:
        for line in f:
            ...
            lidar_count += 1
    print(f"LIDAR data points: {lidar_count}")
    ...
    with open(gnss_file, 'r') as f:
        for line in f:
            ...
            gnss_count += 1
    print(f"GNSS data points: {gnss_count}")
    ...
    with open(imu_file, 'r') as f:
        for line in f:
            ...
            imu_count += 1
    print(f"IMU data points: {imu_count}")
    ...
    print(f"Total data points after processing: {len(merged_data)}")
