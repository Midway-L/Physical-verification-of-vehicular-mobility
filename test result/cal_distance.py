...
def process_car_data(file1, file2):
    ...
    assert len(car1_data) == len(car2_data), "Data points number mismatched"
...
file1 = 'processed_data_lead_id.json' # use lead vehicle data
file2 = 'processed_data_follow_id.json' # use follow vehicle data
output_file = 'cars_distance.json' # carla distance here
