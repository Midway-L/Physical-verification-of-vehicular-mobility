...
def process_data(vehicle_id: str, input_dir: str, output_dir: str):
    ...
    std_file = os.path.join(input_dir, f"std_vehicle_last_vehicle_id.json") # the standard vehicle file from veins_carla as it represents the real start time for the whole simulation, usually the follower for it was spawned later
