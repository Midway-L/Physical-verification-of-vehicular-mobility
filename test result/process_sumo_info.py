...
INPUT_FILES = {
    'std': 'std_vehicle_id.json', # standard vehicle file, usually the last one generated in the simualtion
    'speed_0': 'speed_0.json', # node id in veins
...
def main():
    ...
    print(f"Processed SUMO data saved to {OUTPUT_FILE}")
