...
# 读取 lidar_semantic_282.json 文件
lidar_data = []
with open('lidar_semantic_282.json', 'r') as f:
    for line in f:
        lidar_data.append(json.loads(line.strip()))

# 读取 processed_data_282.json 文件
processed_data = []
with open('processed_data_282.json', 'r') as f:
    for line in f:
...
# 保存新的 JSON 文件
with open('filtered_lidar_data_282.json', 'w') as f:
