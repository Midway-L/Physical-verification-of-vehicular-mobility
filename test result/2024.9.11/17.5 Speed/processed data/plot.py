...
lidar_197_t, lidar_197_d = read_lidar_data('processed_data_2251.json')
lidar_201_t, lidar_201_d = read_lidar_data('processed_data_2255.json')
...
labels = ['Vehicle 2251 LiDAR', 'Vehicle 2255 LiDAR', 'Improved RSSI']
