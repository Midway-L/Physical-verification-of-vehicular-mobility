...
lidar_197_t, lidar_197_d = read_lidar_data('processed_data_417.json')
lidar_201_t, lidar_201_d = read_lidar_data('processed_data_421.json')
...
labels = ['Vehicle 197 LiDAR', 'Vehicle 201 LiDAR', 'Improved RSSI']
